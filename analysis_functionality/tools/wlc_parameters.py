...
def make_dna_parameter(dnaBasePair=5000, persistenceLengthDNA=44.4, stretchModulusDNA=720, persistenceLengthProtein=0.75):
    paramsWLC = {}
    paramsWLC["contourLengthDNA"] = dnaBasePair*0.34
